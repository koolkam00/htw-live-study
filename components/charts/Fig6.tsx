...
export default function Fig6({
  ...
  if (!canRender) return <ChartPlaceholder note="Finish times and estimated slowdown costs by age and recorded ability will appear here." />;
    ...
    <div className="chart" role="img" aria-label="Figure 6 chart">
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={safeSeries}>
          ...
          <YAxis stroke="#8b9bb4" />
          <Tooltip />
          <Line type="monotone" dataKey="value" stroke="#f1a13a" dot={false} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
