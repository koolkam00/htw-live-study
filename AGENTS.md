...
- Respect per-release ID semantics. The audited `private-export-20260911-1107` uses canonical raw/feature record IDs with runtime uniqueness, label and full-timing checks. September 7 CORE/FULL IDs remain incompatible and require the legacy one-to-one natural match. Never infer record alignment from row order or treat cross-race IDs as independently verified people.
