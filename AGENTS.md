...
- Preserve the Smyth HTW definition: slowdown at least 25% for at least 5 km after 20 km relative to the 5–20 km baseline.
...
- Respect per-release ID semantics. September 7 CORE/FULL numeric IDs are incompatible. September 10 claims matching IDs but requires validation before using that contract.
