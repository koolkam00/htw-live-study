...
export default function MethodologyPage() {
  ...
  return <article className="prose">
    ...
    <p>The full export includes runner IDs, matching-ambiguity flags, and historical-performance fields. Personal-best and learning analyses will use these after checking identity matching, race chronology, and whether ability estimates use only earlier results. Exact-age analyses exclude records with only age-group labels. Course overlays lack validity years, so historical terrain has not been assigned to the new runner-level analyses.</p>
