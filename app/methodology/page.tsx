  ...
  return <article className="prose">
    ...
    <details className="methodology" id="fast-start-method">
      ...
      <div className="methodology-content">
        ...
        <p>In All eligible finishes, the main time measure is actual time after 20 km minus the time that distance would take at the recorded 5–20 km pace. Its median and middle 80% describe observed differences from that arithmetic reference, not avoidable minutes or predicted finishes. The actual median finish is shown separately. Mean differences for the first 5 km and after 20 km add to the mean whole-race difference; the 5–20 km reference block contributes zero by definition.</p>
