...
The subsequent ten-analysis redesign shipped in [PR #32](https://github.com/koolkam00/htw-live-study/pull/32), main commit `3e32bf8`, and was verified live. It changes primary navigation, page composition and profile controls, and recalculates the personalized pack to expand supported targets. Its calculation timestamp and script provenance were updated; the September 7 input vintage and sustained-slowdown definition remain unchanged. The later display-unit change requires separate publication verification and does not recalculate any aggregate.
