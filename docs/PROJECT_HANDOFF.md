...
Updated September 12, 2026 for the complete **`private-export-20260912-0934`** refresh on `codex/refresh-20260912-0934`. The [current refresh record](REFRESH_20260912_0934.md) distinguishes source audit, calculation, import and production verification. The [runner-context record](RUNNER_CONTEXT_AND_PEERS.md) and [supporting-study/name-search record](CURRENT_SITE_AND_RUNNER_SEARCH.md) retain their earlier implementation evidence. The public site is [splithappens.run](https://splithappens.run).
